...
void Counter_4_SaveConfig(void) 
{
        ...
        #if (CY_UDB_V0)
            Counter_4_backup.CounterPeriod = Counter_4_ReadPeriod();
            Counter_4_backup.CompareValue = Counter_4_ReadCompare();
            Counter_4_backup.InterruptMaskValue = Counter_4_STATUS_MASK;
        #endif /* CY_UDB_V0 */
...
{      
       ...
       Counter_4_WriteCounter(Counter_4_backup.CounterUdb);
        ...
        #if (CY_UDB_V0)
            Counter_4_WritePeriod(Counter_4_backup.CounterPeriod);
            Counter_4_WriteCompare(Counter_4_backup.CompareValue);
            ...
            Counter_4_STATUS_MASK = Counter_4_backup.InterruptMaskValue;
        #endif  /* (CY_UDB_V0) */
