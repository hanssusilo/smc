...
#define SPI_1_INTERNAL_CLOCK             (0u)
...
#define SPI_1_INTERNAL_RX_INT_ENABLED    (0u)
...
#define SPI_1_INT_ON_RX_NOT_EMPTY    ((uint8) (0u << \
...
#define SPI_1_CONTROL_REG            (* (reg8 *) \
                                      SPI_1_BSPIM_BidirMode_SyncCtl_CtrlReg__CONTROL_REG)
