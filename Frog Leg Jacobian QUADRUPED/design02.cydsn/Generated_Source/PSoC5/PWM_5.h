...
**************************************/
#define PWM_5_INIT_PERIOD_VALUE        12000u
#define PWM_5_INIT_COMPARE_VALUE1      90u
#define PWM_5_INIT_COMPARE_VALUE2      90u
#define PWM_5_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << PWM_5_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_5_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << PWM_5_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << PWM_5_STATUS_KILL_INT_EN_MASK_SHIFT )))
...
******************************** */
    ...
    ***********************************/
    ...
    #define PWM_5_CTRL_CMPMODE1_SHIFT    0x04u  /* As defined by Register map as MODE_CFG bits in CFG2*/
    
    #define PWM_5_CTRL_DEAD_TIME_SHIFT   0x06u   /* As defined by Register map */

    /* Fixed Function Block Only CFG register bit definitions */
    #define PWM_5_CFG0_MODE              0x02u   /*  Set to compare mode */
    
    /* #define PWM_5_CFG0_ENABLE            0x01u */  /* Enable the block to run */
    #define PWM_5_CFG0_DB                0x20u   /* As defined by Register map as DB bit in CFG0 */
    ...
    #define PWM_5_STATUS_TC_SHIFT            0x07u   /* As defined by Register map as TC in SR0 */
    #define PWM_5_STATUS_CMP1_SHIFT          0x06u   /* As defined by the Register map as CAP_CMP in SR0 */
    ...
    #define PWM_5_RT1_MASK              (uint8)((uint8)0x03u << PWM_5_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define PWM_5_SYNC                  (uint8)((uint8)0x03u << PWM_5_RT1_SHIFT)
    #define PWM_5_SYNCDSI_SHIFT         0x00u
    #define PWM_5_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << PWM_5_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define PWM_5_SYNCDSI_EN            (uint8)((uint8)0x0Fu << PWM_5_SYNCDSI_SHIFT) /* Sync all DSI inputs */
